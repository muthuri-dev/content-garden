...
export default async function Home() {
  const data: ITrending = await getMovies();
  return (
    <main className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div className="grid gap-4 sm:grid-col-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
            ...
            >
              ...
              >
                <Image
                  ...
                  width={500}
                  height={500}
                  className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-100"
                />
              </Link>
